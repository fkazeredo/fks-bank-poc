...
class PkceAuthorizationCodeTokenGranter extends AuthorizationCodeTokenGranter {

	PkceAuthorizationCodeTokenGranter(AuthorizationServerTokenServices tokenServices,
	...
	protected OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
		...
		String codeChallenge = request.requestParameters.get("code_challenge")
		String codeChallengeMethod = request.requestParameters.get("code_challenge_method")
		String codeVerifier = request.requestParameters.get("code_verifier")
